...
public class App {
  public static void main(String[] args) {
    ...
    // try {
    //     new com.example.vendingmachineservice.demodata.DemoDataService().generateDemoData(
    //         io.teaql.core.UserContext.admin(), 
    //         com.example.vendingmachineservice.demodata.DemoDataService.DemoDataPlan.small()
    //     );
    // } catch (Exception e) {
    //     e.printStackTrace();
    // }
