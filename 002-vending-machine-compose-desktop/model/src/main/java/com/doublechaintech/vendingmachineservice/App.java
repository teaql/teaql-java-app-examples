...
public class App {
  public static void main(String[] args) {
    ...
    // try {
    //     new com.doublechaintech.vendingmachineservice.demodata.DemoDataService().generateDemoData(
    //         io.teaql.core.UserContext.admin(), 
    //         com.doublechaintech.vendingmachineservice.demodata.DemoDataService.DemoDataPlan.small()
    //     );
    // } catch (Exception e) {
    //     e.printStackTrace();
    // }
