package com.doublechaintech.vendingmachineservice.controller;
...
public class VendingController {
    ...
    public VendingOrder addToCart(@RequestParam(required = false) Long orderId,
    ...
    public OrderPayment checkout(@RequestParam Long orderId) {
