...
public class Q  {
  ...
  public static com.example.vendingmachineservice.dataservice.DataServiceRequest<com.example.vendingmachineservice.dataservice.DataService> dataServices(){
      return new com.example.vendingmachineservice.dataservice.DataServiceRequest(com.example.vendingmachineservice.dataservice.DataService.class).selectSelf().withVersion(Operator.GREATER_THAN, 0l);
  }
  public static com.example.vendingmachineservice.dataservice.DataServiceRequest<com.example.vendingmachineservice.dataservice.DataService> dataServicesWithMinimalFields(){
      return new com.example.vendingmachineservice.dataservice.DataServiceRequest(com.example.vendingmachineservice.dataservice.DataService.class).withVersion(Operator.GREATER_THAN, 0l);
  }
