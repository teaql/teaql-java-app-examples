 ...
 */
public class MatchStage extends BaseEntity implements RemoteInput {
    public static String INTERNAL_TYPE = "MatchStage";
    ...
    public MatchStage updateName(String name){
    ...
    public MatchStage updateCode(String code){
    ...
    public MatchStage updateTournament(Tournament tournament){
    ...
    public MatchStage addTournamentMatch(TournamentMatch tournamentMatch){
        ...
        tournamentMatch.cacheRelation(TournamentMatch.MATCH_STAGE_PROPERTY, this);
        return this;
    }

    public static MatchStage refer(Long id){
        MatchStage refer = new MatchStage();
    ...
    public MatchStage comment(String comment){
