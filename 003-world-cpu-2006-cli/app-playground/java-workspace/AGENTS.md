...
This workspace is the Spring Boot runtime for the TeaQL domain package `com.example.fifaworldcupservice`.
...
Extend `CustomUserContext` or the generated `FifaWorldCup2026ServiceUserContext` type for context-specific behavior instead of reaching into runtime internals.
...
- `Tournament`: `Q.tournaments()`, reverse relations `11`, class `com.example.fifaworldcupservice.tournament.Tournament`
- `TournamentTeam`: `Q.tournamentTeams()`, reverse relations `5`, class `com.example.fifaworldcupservice.tournamentteam.TournamentTeam`
- `MatchGroup`: `Q.matchGroups()`, reverse relations `2`, class `com.example.fifaworldcupservice.matchgroup.MatchGroup`

## All Domain Entry Points

- `MatchStage`: `Q.matchStages()`, reverse relations `1`, class `com.example.fifaworldcupservice.matchstage.MatchStage`
- `MatchStatus`: `Q.matchStatuses()`, reverse relations `1`, class `com.example.fifaworldcupservice.matchstatus.MatchStatus`
- `GoalCategory`: `Q.goalCategories()`, reverse relations `1`, class `com.example.fifaworldcupservice.goalcategory.GoalCategory`
- `CardCategory`: `Q.cardCategories()`, reverse relations `1`, class `com.example.fifaworldcupservice.cardcategory.CardCategory`
- `Confederation`: `Q.confederations()`, reverse relations `1`, class `com.example.fifaworldcupservice.confederation.Confederation`
- `Tournament`: `Q.tournaments()`, reverse relations `11`, class `com.example.fifaworldcupservice.tournament.Tournament`
- `TournamentTeam`: `Q.tournamentTeams()`, reverse relations `5`, class `com.example.fifaworldcupservice.tournamentteam.TournamentTeam`
- `MatchGroup`: `Q.matchGroups()`, reverse relations `2`, class `com.example.fifaworldcupservice.matchgroup.MatchGroup`
- `TournamentMatch`: `Q.tournamentMatches()`, reverse relations `2`, class `com.example.fifaworldcupservice.tournamentmatch.TournamentMatch`
- `MatchGoal`: `Q.matchGoals()`, reverse relations `0`, class `com.example.fifaworldcupservice.matchgoal.MatchGoal`
- `MatchCard`: `Q.matchCards()`, reverse relations `0`, class `com.example.fifaworldcupservice.matchcard.MatchCard`
- `GroupStanding`: `Q.groupStandings()`, reverse relations `0`, class `com.example.fifaworldcupservice.groupstanding.GroupStanding`