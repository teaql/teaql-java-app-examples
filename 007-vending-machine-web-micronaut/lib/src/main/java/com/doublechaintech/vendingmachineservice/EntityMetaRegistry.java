...
public class EntityMetaRegistry implements EntityMetaAssembler {
  ...
  private void registerDataService() {
      EntityDescriptor entityDescriptor = new EntityDescriptor();
      entityDescriptor.setType(com.doublechaintech.vendingmachineservice.dataservice.DataService.INTERNAL_TYPE);
      entityDescriptor.setTargetType(com.doublechaintech.vendingmachineservice.dataservice.DataService.class);
      PropertyDescriptor id = 
      entityDescriptor.addSimpleProperty(com.doublechaintech.vendingmachineservice.dataservice.DataService.ID_PROPERTY, Long.class)
      ;
      PropertyDescriptor name = 
      entityDescriptor.addSimpleProperty(com.doublechaintech.vendingmachineservice.dataservice.DataService.NAME_PROPERTY, String.class)
      ;
      PropertyDescriptor jdbcInfo = 
      entityDescriptor.addSimpleProperty(com.doublechaintech.vendingmachineservice.dataservice.DataService.JDBC_INFO_PROPERTY, String.class)
      ;
      PropertyDescriptor version = 
      entityDescriptor.addSimpleProperty(com.doublechaintech.vendingmachineservice.dataservice.DataService.VERSION_PROPERTY, Long.class)
      ;
      entityDescriptor.findProperty(com.doublechaintech.vendingmachineservice.dataservice.DataService.ID_PROPERTY).with("isPassword", "false")
      .with("isVersion", "false")
      .with("oracle_sqlType", "number(11)")
      .with("javaType", "java.lang.Long")
      .with("sqlType", "BIGINT")
      ...
      entityDescriptor.findProperty(com.doublechaintech.vendingmachineservice.dataservice.DataService.NAME_PROPERTY).with("isPassword", "false")
      .with("max", "100")
      .with("isVersion", "false")
      .with("javaType", "java.lang.String")
      ...
      entityDescriptor.findProperty(com.doublechaintech.vendingmachineservice.dataservice.DataService.JDBC_INFO_PROPERTY).with("isPassword", "false")
      .with("max", "100")
      .with("isVersion", "false")
      .with("javaType", "java.lang.String")
      ...
      entityDescriptor.findProperty(com.doublechaintech.vendingmachineservice.dataservice.DataService.VERSION_PROPERTY).with("isPassword", "false")
      .with("isVersion", "true")
      .with("oracle_sqlType", "number(11)")
      .with("javaType", "java.lang.Long")
      .with("sqlType", "BIGINT")
